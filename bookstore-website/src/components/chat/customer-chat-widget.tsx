...
function SupportModeButton({
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex min-h-10 items-center justify-center gap-2 rounded-xl px-3 py-2 text-xs font-semibold transition-colors disabled:cursor-not-allowed disabled:opacity-60',
        isSelected
