...
export const ADMIN_ROUTE_DEFINITIONS: AdminRouteDefinition[] = [
  ...
  },
  {
    ...
    labelKey: 'admin.sidebar.paymentReconciliation',
    href: '/admin/payment-reconciliation',
    icon: CircleDollarSign,
    allowedRoles: ['ADMIN'],
    keywords: ['payment', 'reconciliation', 'doi soat', 'sepay'],
  },
  {
    id: 'refunds',
    labelKey: 'admin.sidebar.refunds',
    href: '/admin/refunds',
    icon: ArrowLeftRight,
    allowedRoles: ['ADMIN'],
    keywords: ['refund', 'hoan tien', 'bank transfer', 'ledger'],
  },
  {
    id: 'outbox',
    labelKey: 'admin.sidebar.outbox',
    href: '/admin/outbox',
    icon: Send,
    allowedRoles: ['ADMIN'],
    keywords: ['outbox', 'dead letter', 'retry', 'notification'],
  },
  {
    id: 'return-requests',
