...
public class GlobalExceptionHandler {
    ...
    private HttpStatus mapApplicationStatus(ApplicationErrorCode errorCode) {
        return switch (errorCode) {
            case INVALID_ARGUMENT, PAGINATION_INVALID, INVALID_AUTH_PASSWORD, USER_ROLE_NOT_ALLOWED, OTP_INVALID, OTP_EXPIRED, OTP_LOCKED,
            ...
            case OTP_RATE_LIMITED, AUTH_RATE_LIMITED, NEWSLETTER_RATE_LIMITED -> HttpStatus.TOO_MANY_REQUESTS;
            ...
            case FILE_STORAGE_SAFETY_LIMIT_REACHED -> HttpStatus.INSUFFICIENT_STORAGE;
            ...
            case USER_ALREADY_EXISTS, USER_USERNAME_ALREADY_EXISTS, USER_PHONE_ALREADY_EXISTS, USER_EMAIL_ALREADY_EXISTS,
                 ...
                 CATEGORY_NAME_ALREADY_EXISTS, CATEGORY_CODE_ALREADY_EXISTS,
