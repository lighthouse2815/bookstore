...
public final class Guard {
    ...
    public static String phoneNumberOrNull(String value, DomainErrorCode errorCode, String fieldName) {
    ...
    public static String emailOrNull(String value, DomainErrorCode errorCode, String fieldName) {
        return value == null ? null : email(value, errorCode, fieldName);
    }
