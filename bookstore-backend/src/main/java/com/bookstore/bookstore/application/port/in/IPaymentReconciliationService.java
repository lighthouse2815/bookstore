...
public interface IPaymentReconciliationService {
    ...
    PageSliceResult<PaymentReconciliationIssueResult> getPage(int page, int size, PaymentReconciliationStatus status, PaymentReconciliationIssueType type, Instant from, Instant to);
