...
@Table(name = "refunds", indexes = {
        ...
        @Index(name = "idx_refunds_status_requested_at", columnList = "status,requested_at"),
...
public class RefundJpaEntity {
    ...
    @Column(name = "return_request_id", updatable = false)
    ...
    @Column(name = "evidence_metadata", columnDefinition = "LONGTEXT")
